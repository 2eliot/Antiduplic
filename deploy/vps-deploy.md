...
- `PYTHON_BIN`: usa `python3.9`, `python39`, `python3.10` o `python3.11` si `python3` en el VPS es más viejo que 3.9.
...
ssh SSH_USER@159.198.45.30 "python3 --version || true; python3.11 --version || true; python3.10 --version || true; python3.9 --version || true; python39 --version || true"
ssh SSH_USER@159.198.45.30 "export GIT_REPO_URL='https://github.com/2eliot/Antiduplic.git'; export GIT_BRANCH='main'; export PYTHON_BIN='python3.9'; bash /opt/antiduplic/deploy/bootstrap_vps.sh"
```
